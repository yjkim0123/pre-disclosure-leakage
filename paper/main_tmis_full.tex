...
We observe a structural shift in event-day CARs: positive during 2020--2022 (COVID-19 recovery) and negative during 2024--2026 (Figure~\ref{fig:year}). A significant quarterly pattern emerges, with Q1 disclosures generating negative CARs ($-$0.51\%, $p$=0.010) and Q2 generating positive CARs (+0.60\%, $p$=0.003), as shown in Figure~\ref{fig:quarter}. Cross-sectional OLS of CAR[-3,$-$1] on log(size) and beta yields $R^2=0.002$, confirming that firm characteristics explain virtually none of the pre-disclosure drift.

Figure~\ref{fig:dist} shows the distribution of individual-event CARs, illustrating the positive skewness that drives the parametric significance despite a near-zero median.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\columnwidth]{figures/fig4_quarter.pdf}
\caption{CARs by fiscal quarter. Q1 disclosures generate negative event-day CARs while Q2 generates positive, suggesting seasonal earnings patterns.}
\label{fig:quarter}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.85\columnwidth]{figures/fig5_distributions.pdf}
\caption{Distribution of individual-event CARs for the [-5,$-$1] window. The positive mean (+0.52\%) is driven by right-tail outliers; the median is near zero, consistent with non-directional drift.}
\label{fig:dist}
\end{figure}
